...
export default function InningsAnalytics() {
  ...
  const { data, isLoading } = useQuery({
    ...
    queryFn: () => api.get(`/scoring/innings/${inningsId}/analytics`).then(r => r.data),
  ...
  const { data: partnerships } = useQuery({
    ...
    queryFn: () => api.get(`/scoring/innings/${inningsId}/partnerships`).then(r => r.data.partnerships),
    enabled: Boolean(inningsId)
  });

  const { data: fielding } = useQuery({
    queryKey: ["innings-fielding", inningsId],
    queryFn: () => api.get(`/scoring/innings/${inningsId}/fielding`).then(r => r.data.fielding),
    enabled: Boolean(inningsId)
  });
