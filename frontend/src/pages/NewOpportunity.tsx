...
export default function NewOpportunity() {
  ...
  return (
    <form onSubmit={submit} className="space-y-4 max-w-3xl">
      <PageHeader title="Post an opportunity" subtitle="Trials, recruitment, scholarships, tournaments, coaching jobs." />
      ...
      <button className="btn-primary" disabled={busy}>{busy ? "Posting..." : "Post opportunity"}</button>
    </form>
  );
}
